...
grep , /home/pi/HydroponicsCabinet/sensors.log | cut -d, -f1 > sensorTemperature.log
awk '{s+=$1}END{print NR?s/NR:NaN}' /home/pi/HydroponicsCabinet/sensorTemperature.log > /home/pi/HydroponicsCabinet/sensorTemperatureAverage.log
